  ...
  <div class="container">
    <div class="savingThrows">
      <div class="skill">
        ...
        <button class="skillBtn" @click="roll(skillsStore.strength)" @click.right.prevent="roll(skillsStore.strength,true)"value="Strength Save"></button>
      </div>
      <div class="skill">
        ...
        <button class="skillBtn" @click="roll(skillsStore.dexterity)" @click.right.prevent="roll(skillsStore.dexterity,true)"value="Dexterity Save"></button>
      </div>
      <div class="skill">
        ...
        <button class="skillBtn" @click="roll(skillsStore.constitution)" @click.right.prevent="roll(skillsStore.constitution,true)" value="Constitution Save"></button>
      </div>
      <div class="skill">
        ...
        <button class="skillBtn" @click="roll(skillsStore.intelligence)" @click.right.prevent="roll(skillsStore.intelligence,true)"value="Intelligence Save"></button>
      </div>
      <div class="skill">
        ...
        <button class="skillBtn" @click="roll(skillsStore.wisdom)" @click.right.prevent="roll(skillsStore.wisdom,true)"value="Wisdom Save"></button>
      </div>
      <div class="skill">
        ...
        <button class="skillBtn" @click="roll(skillsStore.charisma)" @click.right.prevent="roll(skillsStore.charisma,true)"value="Charisma Save"></button>
      </div>
    ...
    <div class="skills">
      <div class="skill">
        ...
        <button class="skillBtn" @click="roll(skillsStore.acrobatics)" @click.right.prevent="roll(skillsStore.acrobatics,true)"value="Acrobatics"></button>
      </div>
      <div class="skill">
        ...
        <button class="skillBtn" @click="roll(skillsStore.animalHandling)" @click.right.prevent="roll(skillsStore.animalHandling,true)"value="Animal Handling"></button>
      </div>
      <div class="skill">
        ...
        <button class="skillBtn" @click="roll(skillsStore.arcana)" @click.right.prevent="roll(skillsStore.arcana,true)"value="Arcana"></button>
      </div>
      <div class="skill">
        ...
        <button class="skillBtn" @click="roll(skillsStore.athletics)" @click.right.prevent="roll(skillsStore.athletics,true)"value="Athletics"></button>
      </div>
      <div class="skill">
        ...
        <button class="skillBtn" @click="roll(skillsStore.deception)" @click.right.prevent="roll(skillsStore.deception,true)"value="Deception"></button>
      </div>
      <div class="skill">
        ...
        <button class="skillBtn" @click="roll(skillsStore.history)" @click.right.prevent="roll(skillsStore.history,true)"value="History"></button>
      </div>
      <div class="skill">
        ...
        <button class="skillBtn" @click="roll(skillsStore.insight)" @click.right.prevent="roll(skillsStore.insight,true)"value="Insight"></button>
      </div>
      <div class="skill">
        ...
        <button class="skillBtn" @click="roll(skillsStore.intimidation)" @click.right.prevent="roll(skillsStore.intimidation,true)"value="Intimidation"></button>
      </div>
      <div class="skill">
        ...
        <button class="skillBtn" @click="roll(skillsStore.investigation)" @click.right.prevent="roll(skillsStore.investigation,true)"value="Investigation"></button>
      </div>
      <div class="skill">
        ...
        <button class="skillBtn" @click="roll(skillsStore.medicine)" @click.right.prevent="roll(skillsStore.medicine,true)"value="Medicine"></button>
      </div>
      <div class="skill">
        ...
        <button class="skillBtn" @click="roll(skillsStore.nature)" @click.right.prevent="roll(skillsStore.nature,true)"value="Nature"></button>
      </div>      <div class="skill">
        ...
        <button class="skillBtn" @click="roll(skillsStore.perception)" @click.right.prevent="roll(skillsStore.perception,true)"value="Perception"></button>
      </div>
      <div class="skill">
        ...
        <button class="skillBtn" @click="roll(skillsStore.performance)" @click.right.prevent="roll(skillsStore.performance,true)"value="Performance"></button>
      </div>
      <div class="skill">
        ...
        <button class="skillBtn" @click="roll(skillsStore.persuasion)" @click.right.prevent="roll(skillsStore.persuasion,true)"value="Persuasion"></button>
      </div>
      <div class="skill">
        ...
        <button class="skillBtn" @click="roll(skillsStore.religion)" @click.right.prevent="roll(skillsStore.religion,true)"value="Religion  "></button>
      </div>
      <div class="skill">
        ...
        <button class="skillBtn" @click="roll(skillsStore.sleightOfHand)" @click.right.prevent="roll(skillsStore.sleightOfHand,true)"value="Sleight of Hand"></button>
      </div>
      <div class="skill">
        ...
        <button class="skillBtn" @click="roll(skillsStore.stealth)" @click.right.prevent="roll(skillsStore.stealth,true)"value="Stealth"></button>
      </div>
      <div class="skill">
        ...
        <button class="skillBtn" @click="roll(skillsStore.survival)" @click.right.prevent="roll(skillsStore.survival,true)"value="Survival"></button>
      </div>
    </div>
  </div>
